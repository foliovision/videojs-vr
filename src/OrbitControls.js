...
const OrbitControls = function(object, domElement) {
  ...
  this.update = (function() {
    ...
    return function update() {
      ...
      if (scope.currentDistance >= 0) {
        const newRad = scope.currentDistance;
      ...
      {
        const newFov = 75 + scope.currentDistance * 0.06;
  ...
  function dollyIn(dollyScale) {
    ...
    } else if (!scope.object.isPerspectiveCamera) { // dolly for perspective camera not implemented
